...
const Dashboard = () => {
    ...
    const loadStats = () => {
        try {
            ...
            // 2. إجمالي المنتجات
            const prodCountRes = dbService.exec("SELECT count(*) FROM products");
            ...
            // 4. آخر المبيعات
            const recentSalesRes = dbService.exec("SELECT total, payment_method, created_at FROM sales ORDER BY id DESC LIMIT 5");
